...
<head>
<meta charset="UTF-8">
	<title>Usuario | Historial de clases</title>
			...
			<div class="main-content">
				<div class="wrap-content container" id="container">
					...
					<section id="page-title">
						<div class="row">
							<div class="col-sm-8">
								<h1 class="mainTitle">Usuario | Historial de clases</h1>
							</div>
							<ol class="breadcrumb">
								<li>
									<span>User </span>
							...
							<div class="col-md-12">
								...
								<table class="table table-hover" id="sample-table-1">
									<thead>
										<tr>
											<th class="center">#</th>
											<th class="hidden-xs">Nombre de Coach</th>
											<th>Material</th>
											<th>Cuota</th>
											<th>Fecha de clase / Hora</th>
											<th>Fecha de Creación de Clase </th>
											<th>Status Actual</th>
											<th>Accioó</th>
