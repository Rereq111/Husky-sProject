	...
	<body class="login">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../index.html"><h2> GP | Reiniciar Contraseña Alumnos</h2></a>
				</div>
				...
				<div class="box-login">
					<form class="form-login" name="passwordreset" method="post" onSubmit="return valid();">
						<fieldset>
							<legend>
								Reiniciar Contraseña Maestros
							</legend>
							<p>
								Escriba su nueva contraseña.<br />
...
<i class="fa fa-lock"></i> </span>
					...
					<div class="copyright">
						&copy; <span class="current-year"></span><span class="text-bold text-uppercase"> YY Inc.</span>. <span>All rights reserved</span>
					</div>
