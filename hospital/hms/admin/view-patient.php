...
<div class="row">
<div class="col-sm-8">
<h1 class="mainTitle">Coach | Administrar Alumnos</h1>
</div>
<ol class="breadcrumb">
<li>
<span>Doctor</span>
...
<td colspan="4" style="font-size:20px;color:blue">
 Detalles del Alumno</td></tr>
  ...
  <tr>
    <th scope>Numero de Contacto</th>
  ...
  <tr>
    ...
    <th>Historial Medico Alumno(Si tiene)</th>
    <td><?php  echo $row['PatientMedhis'];?></td>
     <th>Alumno Reg Date</th>
