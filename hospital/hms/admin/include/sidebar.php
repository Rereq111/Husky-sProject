							...
							<li>
								<a href="javascript:void(0)">
									<div class="item-content">
										...
										<div class="item-inner">
											<span class="title"> Coaches </span><i class="icon-arrow"></i>
										</div>
									</div>
								</a>
								<ul class="sub-menu">
									<li>
										<a href="doctor-specilization.php">
											<span class="title"> Material Coaches </span>
										</a>
									</li>
									<li>
									...
									<li>
										<a href="Manage-doctors.php">
											<span class="title"> Administrar Coaches </span>
										</a>
									</li>
...
<li>
								<a href="appointment-history.php">
									<div class="item-content">
										...
										<div class="item-inner">
											<span class="title"> Historial de Clases </span>
										</div>
									</div>
								</a>
							</li>
				...
				<li>
								<a href="javascript:void(0)">
									<div class="item-content">
										...
										<div class="item-inner">
											<span class="title"> Mensajes De Contacto </span><i class="icon-arrow"></i>
										</div>
									</div>
								</a>
								<ul class="sub-menu">
