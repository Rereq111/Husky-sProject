...
if($sql)
{
echo "<script>alert('Coach Añadido Correctamente');</script>";
...
<html lang="en">
	<head>
		<title>Admin | Añadir Coach</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin | Añadir Coach</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin</span>
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Añadir Coach</h5>
												</div>
...
<div class="form-group">
					...
					<input type="text" name="docname" class="form-control"  placeholder="Ingresar Nombre" required="true">
														</div>
...
<div class="form-group">
					...
					<input type="text" name="docfees" class="form-control"  placeholder="Ingresar Cuota(precio)" required="true">
														</div>
...
<div class="form-group">
					...
					<input type="text" name="doccontact" class="form-control"  placeholder="Ingresar Numero" required="true">
														</div>
